...
#### Сценарий :
1. Проверить по tenantCode наличие УЗ по данному тенанту в таблице acc_logins. Если запись НЕ найдена, то перейти на шаг 2, иначе исключение 2а
~~~
SELECT
    t.id AS tenant_id,
...
5. Вернуть ответ GET /tnts/{tenantCode}/logins
